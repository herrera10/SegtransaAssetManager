...
namespace FrontEnd.CategoriasDataSetTableAdapters {
    ...
    public partial class CategoriasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Categorias] SET [Descripcion] = @Descripcion WHERE (([IdCategoria] = @Original_IdCategoria) AND ((@IsNull_Descripcion = 1 AND [Descripcion] IS NULL) OR ([Descripcion] = @Original_Descripcion)));
SELECT IdCategoria, Descripcion FROM Categorias WHERE (IdCategoria = @IdCategoria)";
        ...
        public virtual int Fill(CategoriasDataSet.CategoriasDataTable dataTable) {
        ...
        public virtual CategoriasDataSet.CategoriasDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CategoriasDataSet.CategoriasDataTable dataTable = new CategoriasDataSet.CategoriasDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CategoriasDataSet.CategoriasDataTable dataTable) {
